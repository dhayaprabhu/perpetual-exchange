...
contract Timelock is ITimelock {
    ...
    uint256 public constant MAX_LEVERAGE_VALIDATION = 12500000; // 1250x
    ...
    function setStopLossAndTakeProfit(
        ...
        IVault(_vault).setStopLossAndTakeProfit(
            _minStopLossPercent,
            _maxStopLossPercent,
            _minTakeProfitPercent,
            _maxTakeProfitPercent
        );
    }
    ...
    function setSuperTrader(address _vault, ISuperTrader _superTrader) external onlyAdmin {
        IVault(_vault).setSuperTrader(_superTrader);
    }
